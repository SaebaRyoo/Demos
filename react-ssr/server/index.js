...
const renderMarkup = (str, template) => {
    ...
    return template
        ...
        .replace('<!--REACT_PLACEHOLDER-->', '<script type="text/javascript" src="https://unpkg.com/react@18/umd/react.production.min.js"></script>')
        .replace('<!--REACT_DOM_PLACEHOLDER-->', '<script type="text/javascript" src="https://unpkg.com/react-dom@18/umd/react-dom.production.min.js"></script>')
